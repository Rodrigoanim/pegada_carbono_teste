    ...
    try:
        ...
        for e_row, elements_group in row_elements.items():
            ...
            if tabela and grafico:
                ...
                pdf.cell(70, 10, "Descrição", 1, 0, 'L', True)
                pdf.cell(60, 10, "Valor", 1, 1, 'R', True)
                ...
                # Configurar estilo do gráfico manualmente
                plt.figure(figsize=(8, 6))
                
                # Configurar fonte sans-serif para o gráfico
                ...
                # Adicionar valores sobre as barras com fonte sans-serif
                for bar in bars:
                    height = bar.get_height()
                    plt.text(bar.get_x() + bar.get_width()/2., height,
                            format_br_number(height),
                            ha='center', va='bottom', fontsize=12,
                            family='sans-serif')
                
                # Configurar título do gráfico usando msg_element do gráfico
                plt.title(grafico[2], fontsize=14, pad=20, family='sans-serif')  # msg_element do gráfico
                ...
                with tempfile.NamedTemporaryFile(delete=False, suffix=".png") as temp_file:
                    ...
                    # Posicionar gráfico na coluna direita
                    pdf.image(temp_file.name, x=150, y=y_start, w=130)
